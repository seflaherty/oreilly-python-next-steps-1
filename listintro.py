...
class TestSkilz(unittest.TestCase):
    def test_creation(self):
        ...
        #
        # ===========================================
        faang = ['Netflix', 'Amazon', 'Facebook', 'Google', 'Apple']
        faang = 'Netflix Amazon Facebook Google Apple'.split()
        faang = list(('Netflix', 'Amazon', 'Facebook', 'Google', 'Apple'))
        ...
        #
        # ===========================================
        #faang.append('Microsoft')
        other_cos = ['Microsoft']
        faang.extend(other_cos)
